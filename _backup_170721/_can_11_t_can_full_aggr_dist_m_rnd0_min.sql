DROP TABLE IF EXISTS t_can_full_aggr_dist_m_rnd0_min CASCADE;
CREATE TABLE t_can_full_aggr_dist_m_rnd0_min AS

SELECT

min("public".t_can_full.rownr) as rownr,
row_number() over (partition by "public".t_can_full.subid, "public".t_can_full.dist_m_rnd0 order by min("public".t_can_full.rownr)) as rownr_aggr,
...
min("public".t_can_full.s99_dist_s_rnd0) as s99_dist_s_rnd0,
--
...
min("public".t_can_full.s99_dist_m_rnd0) as s99_dist_m_rnd0,
--
