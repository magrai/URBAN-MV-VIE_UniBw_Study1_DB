--DROP TABLE IF EXISTS t_videoannot_sxx_t1_t2_v2;
--CREATE TABLE t_videoannot_sxx_t1_t2_v2 AS
...
(
	...
	(	SELECT
		t_can_xlimits."final" * (-1)::numeric as entf
		FROM
		t_can_xlimits
		WHERE
		t_can_xlimits."Situation" = 1
	) entf_temp
	
	WHERE
	t_can_sxx_gesamt_aggr_zeit.s01_entf_m_rounded >= entf_temp.entf-1 AND
	t_can_sxx_gesamt_aggr_zeit.s01_entf_m_rounded <= entf_temp.entf+1
...
(
	...
	(	SELECT
		...
		t_can_xlimits
		WHERE
		t_can_xlimits."Situation" = 2
	) entf_temp
	
	WHERE
	t_can_sxx_gesamt_aggr_zeit.s02_entf_m_rounded >= entf_temp.entf-1 AND
	t_can_sxx_gesamt_aggr_zeit.s02_entf_m_rounded <= entf_temp.entf+1
...
(
	...
	(	SELECT
		...
		t_can_xlimits
		WHERE
		t_can_xlimits."Situation" = 3
	) entf_temp
	
	WHERE
	t_can_sxx_gesamt_aggr_zeit.s03_entf_m_rounded >= entf_temp.entf-1 AND
	t_can_sxx_gesamt_aggr_zeit.s03_entf_m_rounded <= entf_temp.entf+1
...
(
	...
	(	SELECT
		...
		t_can_xlimits
		WHERE
		t_can_xlimits."Situation" = 4
	) entf_temp
	
	WHERE
	t_can_sxx_gesamt_aggr_zeit.s04_entf_m_rounded >= entf_temp.entf-1 AND
	t_can_sxx_gesamt_aggr_zeit.s04_entf_m_rounded <= entf_temp.entf+1
...
(
	...
	(	SELECT
		...
		t_can_xlimits
		WHERE
		t_can_xlimits."Situation" = 5
	) entf_temp
	
	WHERE
	t_can_sxx_gesamt_aggr_zeit.s05_entf_m_rounded >= entf_temp.entf-1 AND
	t_can_sxx_gesamt_aggr_zeit.s05_entf_m_rounded <= entf_temp.entf+1
...
(
	...
	(	SELECT
		...
		t_can_xlimits
		WHERE
		t_can_xlimits."Situation" = 6
	) entf_temp
	
	WHERE
	t_can_sxx_gesamt_aggr_zeit.s06_entf_m_rounded >= entf_temp.entf-1 AND
	t_can_sxx_gesamt_aggr_zeit.s06_entf_m_rounded <= entf_temp.entf+1
...
(
	...
	(	SELECT
		...
		t_can_xlimits
		WHERE
		t_can_xlimits."Situation" = 7
	) entf_temp
	
	WHERE
	t_can_sxx_gesamt_aggr_zeit.s07_entf_m_rounded >= entf_temp.entf-1 AND
	t_can_sxx_gesamt_aggr_zeit.s07_entf_m_rounded <= entf_temp.entf+1
...
(
	...
	(	SELECT
		...
		t_can_xlimits
		WHERE
		t_can_xlimits."Situation" = 8
	) entf_temp
	
	WHERE
	t_can_sxx_gesamt_aggr_zeit.s08_entf_m_rounded >= entf_temp.entf-1 AND
	t_can_sxx_gesamt_aggr_zeit.s08_entf_m_rounded <= entf_temp.entf+1
...
(
	...
	(	SELECT
		...
		t_can_xlimits
		WHERE
		t_can_xlimits."Situation" = 9
	) entf_temp
	
	WHERE
	t_can_sxx_gesamt_aggr_zeit.s09_entf_m_rounded >= entf_temp.entf-1 AND
	t_can_sxx_gesamt_aggr_zeit.s09_entf_m_rounded <= entf_temp.entf+1
...
(
	...
	(	SELECT
		...
		t_can_xlimits
		WHERE
		t_can_xlimits."Situation" = 10
	) entf_temp
	
	WHERE
	t_can_sxx_gesamt_aggr_zeit.s10_entf_m_rounded >= entf_temp.entf-1 AND
	t_can_sxx_gesamt_aggr_zeit.s10_entf_m_rounded <= entf_temp.entf+1
...
(
	...
	(	SELECT
		...
		t_can_xlimits
		WHERE
		t_can_xlimits."Situation" = 11
	) entf_temp
	
	WHERE
	t_can_sxx_gesamt_aggr_zeit.s11_entf_m_rounded >= entf_temp.entf-1 AND
	t_can_sxx_gesamt_aggr_zeit.s11_entf_m_rounded <= entf_temp.entf+1
...
(
	...
	(	SELECT
		...
		t_can_xlimits
		WHERE
		t_can_xlimits."Situation" = 12
	) entf_temp
	
	WHERE
	t_can_sxx_gesamt_aggr_zeit.s12_entf_m_rounded >= entf_temp.entf-1 AND
	t_can_sxx_gesamt_aggr_zeit.s12_entf_m_rounded <= entf_temp.entf+1
...
(
	...
	(	SELECT
		...
		t_can_xlimits
		WHERE
		t_can_xlimits."Situation" = 13
	) entf_temp
	
	WHERE
	t_can_sxx_gesamt_aggr_zeit.s13_entf_m_rounded >= entf_temp.entf-1 AND
	t_can_sxx_gesamt_aggr_zeit.s13_entf_m_rounded <= entf_temp.entf+1
...
(
	...
	(	SELECT
		...
		t_can_xlimits
		WHERE
		t_can_xlimits."Situation" = 14
	) entf_temp
	
	WHERE
	t_can_sxx_gesamt_aggr_zeit.s14_entf_m_rounded >= entf_temp.entf-1 AND
	t_can_sxx_gesamt_aggr_zeit.s14_entf_m_rounded <= entf_temp.entf+1
...
(
	...
	(	SELECT
		...
		t_can_xlimits
		WHERE
		t_can_xlimits."Situation" = 15
	) entf_temp
	
	WHERE
	t_can_sxx_gesamt_aggr_zeit.s15_entf_m_rounded >= entf_temp.entf-1 AND
	t_can_sxx_gesamt_aggr_zeit.s15_entf_m_rounded <= entf_temp.entf+1
...
(
	...
	(	SELECT
		...
		t_can_xlimits
		WHERE
		t_can_xlimits."Situation" = 16
	) entf_temp
	
	WHERE
	t_can_sxx_gesamt_aggr_zeit.s16_entf_m_rounded >= entf_temp.entf-1 AND
	t_can_sxx_gesamt_aggr_zeit.s16_entf_m_rounded <= entf_temp.entf+1
...
(
	...
	(	SELECT
		...
		t_can_xlimits
		WHERE
		t_can_xlimits."Situation" = 17
	) entf_temp
	
	WHERE
	t_can_sxx_gesamt_aggr_zeit.s17_entf_m_rounded >= entf_temp.entf-1 AND
	t_can_sxx_gesamt_aggr_zeit.s17_entf_m_rounded <= entf_temp.entf+1
...
(
	...
	t_can_sxx_gesamt_aggr_zeit.runde,
	t_can_sxx_gesamt_aggr_zeit.runde_txt,
	min(to_char((to_timestamp((t_can_sxx_gesamt_aggr_pgadzeit.zeit_s)::double precision) - ('01:00:00'::time without time zone)::interval), 'HH24:MI:SS'::text)) AS s18_zeit_t1
	...
	(	SELECT
		...
		t_can_xlimits
		WHERE
		t_can_xlimits."Situation" = 18
	) entf_temp
	
	WHERE
	t_can_sxx_gesamt_aggr_zeit.s18_entf_m_rounded >= entf_temp.entf-1 AND
	t_can_sxx_gesamt_aggr_zeit.s18_entf_m_rounded <= entf_temp.entf+1
