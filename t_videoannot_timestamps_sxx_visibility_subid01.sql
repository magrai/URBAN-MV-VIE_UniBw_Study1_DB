DROP TABLE IF EXISTS t_videoannot_timestamps_sxx_visibility_subid01;
CREATE TABLE t_videoannot_timestamps_sxx_visibility_subid01 AS
...
(
	...
	t_glances_full_aggr_dist_m_rnd0_max_dist2sxx_v2.subid = 1 AND
